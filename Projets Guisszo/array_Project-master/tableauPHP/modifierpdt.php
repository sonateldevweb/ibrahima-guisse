...
<header>
        ...
        <input type="number" class="form-control mb-2 mr-sm-2" id="quantite"  name="quantite">
          <button type="submit" name="Modifier" class="btn btn-outline-primary">Modifierer</button>
  </form>
        </div>
          ...
          <thead>
           ...
           <thead>
            ...
            if(isset($_POST['Modifier']))
            {
                ...
                if(isset($nomProd) && isset($prix) && isset($quantite))
                {  
                  echo"<tr>";
                  foreach($listProd as $key => $val) { 
                  
                    if($val['nom']==$_POST['nomProd'])
                    {
                     
                      if(($_POST['nomProd'] == $val['nom']) && $boolprix==true && $boolqte==true && $quantite>10)
                      {
                      ...
                      }else
                      {
                        ...
                        //  echo "<td class=bg-danger>".$val['quantite']*$val['prix']."</td>"; 
                      }
