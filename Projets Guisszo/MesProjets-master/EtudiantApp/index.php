...
<header>
        ...
        <nav>
            <ul>
                <li><a href="./pages/ajoutEtud.php" class="active">Aceuil</a></li>
                <li><a href="./pages/AjoutchambreBati.php">Ajout batiment</a></li>
                <li><a href="./pages/Ajoutchambre.php">Ajout Chambre</a></li>
                <li><a href="./pages/listerEtudiant.php">Lister Boursiers</a></li>
                <li><a href="./pages/rechercher.php">Recherche</a></li>
                </li>
            </ul>
        </nav> 
